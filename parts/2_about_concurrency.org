...
#+ATTR_REVEAL: :code_attribs data-line-numbers="|3-6|8-13||10|13|" data-fragment-index=0
...
#+BEGIN_NOTES
- Bug 1: Coroutines that aren't run may eventually log warnings.
- Bug 2: Tasks that aren't awaited are orphaned.
...
- Nested contexts and task-local state
  {{{BR}}}{{{BR}}}
- Well-defined cancellation semantics and error handling
  {{{BR}}}{{{BR}}}
